...
!function(e, t) {
            ...
            for (var p = 1, d = !0; p < n.length; p += 1) {
                ...
                y(h, l))
                    ...
                    if (s && p + 1 >= n.length) {
                        var x = s(c, v);
                        d = !!x,
                        c = d && "get"in x && !("originalValue"in x.get) ? x.get : c[v]
                    } else
                        d = y(c, v),
                        c = c[v];
                    d && !u && (h[l] = c)
    ...
    , function(e, t, n) {
        ...
        a.default)(l.default, {
            ...
            sdkLoader: function(e, t, n) {
                t in window && window[t] ? (_ && clearTimeout(_),
        ...
        var r = n(6)
          , o = {
            ...
            build: function(e, t) {
                var n = /^(https?:)?\/\//i
                  , r = o.maps[e]
                  , i = n.test(r) ? r : o.cdn + r
                  , a = ' <img alt="' + e + '" referrerpolicy="no-referrer" class="vemoji" src="' + i + '" />';
                return n.test(i) ? a : ""
            }
        };
        t.default = o
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t) {
            ...
            if (!a(t))
                throw new o("Assertion failed: IsPropertyKey(P) is not true, got " + i(t));
            return e[t]
        }
    }
    , function(e, t, n) {
    ...
    , function(e, t, n) {
        "use strict";
        var r = n(29)
          , o = ["background", "base", "cite", "href", "longdesc", "src", "usemap"];
        e.exports = {
            uris: r(o)
        }
    }
    , function(e, t, n) {
        "use strict";
        var r = n(29)
          , o = ["area", "br", "col", "hr", "img", "wbr", "input", "base", "basefont", "link", "meta"];
        e.exports = {
            voids: r(o)
        }
    }
            ...
            e: for (c = 0; c < u; c++) {
                ...
                if (!1 === s) {
                    ...
                    if (">" === d) {
                        ...
                        p = e.slice(s, c + 1),
                        f = r(p),
                        i += t(s, i.length, f, p, o(p)),
                        a = c + 1,
                        s = !1;
                        continue
                    }
                    if ('"' === d || "'" === d)
                        for (var h = 1, v = e.charAt(c - h); "" === v.trim() || "=" === v; ) {
                            if ("=" === v) {
                                l = d;
                                continue e
                            }
...
*/
    ...
    , function(e, t, n) {
        ...
        o.prototype.init = function(e) {
            ...
            var t = this;
            return e && (e = S.default.extend(h.CONFIG, e),
            t.i18n = (0,
            f.default)(e.lang || S.default.lang, e.langMode),
            t.cfg = e,
            d.default.maps = !!e.emojiMaps && e.emojiMaps || d.default.maps,
            d.default.cdn = !!e.emojiCDN && e.emojiCDN || d.default.cdn,
            t._init()),
            t
        }
        ,
        o.prototype._init = function() {
            ...
            try {
                ...
                I.hide = "hide" === n,
                I.cdn = /^https?\:\/\//.test(o) ? o : I.cdn,
                e.cfg.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l,
                c && (0,
                b.recordIPFn)(function(e) {
                    return E.ip = e
                });
                var p = e.cfg.el || null
                  , d = (0,
                ...
                if (p = p instanceof HTMLElement ? p : d[d.length - 1] || null) {
                    ...
                    I.hide && e.$el.addClass("hide-avatar"),
                    ...
                    var w = e.$el.find(".vload-bottom")
                      , k = e.$el.find(".vload-top");
                    e.$loading = {
                        show: function(t) {
                            return t && k.show() || w.show(),
                            e.$nodata.hide(),
                            e
                        },
                        hide: function() {
                ...
                (0,
                y.default)(e.cfg, function(t) {
                    var n = (0,
                    S.default)(".valine-comment-count")
                      , r = 0;
                    !function t(n) {
                        var o = n[r++];
                        if (o) {
                            var i = (0,
                            S.default)(o).attr("data-xid");
                    ...
                    i && C.add(AV.Object.extend("Counter"), e.cfg.path),
                    e.$el && e.bind()
                })
            } catch (t) {
                (0,
        ...
        var z = function(e, t) {
            ...
            n.save().then(function(e) {
                (0,
                S.default)(t.el).find(".leancloud-visitors-count").text(1)
            }).catch(function(e) {})
        }
          , C = {
            add: function(e, t) {
                var n = this
                  , r = (0,
                S.default)(".leancloud_visitors,.leancloud-visitors");
                if (1 === r.length) {
                    var o = r[0]
                      , i = decodeURI((0,
                    S.default)(o).attr("id"))
                      , a = (0,
                    S.default)(o).attr("data-flag-title")
                      , s = encodeURI(i)
                      , l = {
                        el: o,
                        url: i,
                    ...
                    if (decodeURI(i) === decodeURI(t)) {
                        ...
                        c.find().then(function(t) {
                            if (t.length > 0) {
                                ...
                                n.save().then(function(e) {
                                    (0,
                                    S.default)(o).find(".leancloud-visitors-count").text(e.get("time"))
                                }).catch(function(e) {})
                            } else
                                z(e, l)
                        }).catch(function(t) {
            ...
            show: function(e, t) {
                ...
                if (t.forEach(function(e) {
                    var t = (0,
                    S.default)(e).find(".leancloud-visitors-count");
                    t && t.text("0"),
                    n.push(/\%/.test((0,
                    S.default)(e).attr("id")) ? decodeURI((0,
                    S.default)(e).attr("id")) : (0,
                    S.default)(e).attr("id"))
                }),
                n.length) {
        ...
        o.prototype.bind = function() {
            var e = this
              ...
              , u = function(e) {
                var n = [];
                for (var r in a)
                    a.hasOwnProperty(r) && !!d.default.build(r) && n.push('<i title="' + r + '" >' + d.default.build(r) + "</i>");
                t.html(n.join("")),
                l = !0,
                t.find("i").on("click", function(e) {
                    e.preventDefault(),
                    w(i[0], " :" + (0,
                    S.default)(this).attr("title") + ":")
                })
            };
            e.$emoji = {
                show: function() {
            ...
            var f = function(t) {
                ...
                r || e.$preview.hide(),
                T != r && (T = r,
                o.hasClass("actived") > -1 && T != n.html() && n.html(T),
                (0,
                c.default)(t[0]),
                P())
            };
                    ...
                    n.on("input change blur propertychange", function(r) {
                        ...
                        b.fetchQQFn)(n.val(), function(e) {
                            var t = e.nick || n.val()
                              , r = e.qq + "@qq.com";
                            (0,
                            S.default)(".vnick").val(t),
                            (0,
                            S.default)(".vmail").val(r),
                            E.nick = t,
                            E.mail = r,
                            E.QQAvatar = e.pic
                        })),
            ...
            var $ = function(t, n, r) {
                var o = (0,
                S.default)('<div class="vcard" id="' + t.id + '"></div>')
                  , i = t.get("ua")
                  , a = "";
                i && !/ja/.test(e.cfg.lang) && (i = S.default.detect(i),
                a = i.os ? '<span class="vsys">' + i.browser + " " + i.version + '</span> <span class="vsys">' + i.os + " " + i.osVersion + "</span>" : ""),
                "*" === e.cfg.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : ""
                  , c = S.default.escape(t.get("nick"))
                  , u = l ? '<a class="vnick" rel="nofollow" href="' + S.default.escape(l) + '" target="_blank" >' + c + "</a>" : '<span class="vnick">' + c + "</span>"
                  , f = I.hide ? "" : e.cfg.enableQQ && t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (I.cdn + (0,
                s.default)(t.get("mail")) + I.params) + '">'
                  , p = f + '<div class="vh"><div class="vhead">' + u + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0,
              ...
              , C = function(t, n) {
                t.on("click", function(r) {
                    var o = t.attr("data-vm-id")
                      ...
                      , a = e.$el.find(".vwrap")
                      , s = "@" + S.default.escape(n.get("nick"));
                    (0,
                    S.default)('.vreply-wrapper[data-self-id="' + i + '"]').append(a).find(".cancel-reply").show(),
                    z = {
            ...
            !function(t) {
                if (t = S.default.store.get(h.MetaCacheKey) || t)
                    for (var n in p)
                        if (p.hasOwnProperty(n)) {
                            var r = p[n];
                            e.$el.find(".v" + r).val(S.default.unescape(t[r])),
                            E[r] = t[r]
                        }
            ...
            var M = e.$el.find(".vsubmit")
              , F = function(t) {
                if (e.cfg.requiredFields.indexOf("nick") > -1 && E.nick.length < 3)
                    return v.nick[0].focus(),
                    void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
                if (e.cfg.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(E.mail))
              ...
              , N = function() {
                S.default.store.set("vlx", Date.now()),
                M.attr({
                    disabled: !0
                }),
                e.$loading.show(!0);
                var t = AV.Object.extend(e.cfg.clazzName || "Comment")
                  , n = new t;
                if (E.url = decodeURI(e.cfg.path),
                E.insertedAt = new Date,
                z.rid) {
                    var r = z.pid || z.rid;
                    n.set("rid", z.rid),
                    n.set("pid", r),
                    E.comment = T.replace("<p>", '<p><a class="at" href="#' + r + '">' + z.at + "</a> , ")
                }
                for (var o in E)
                ...
                n.save().then(function(t) {
                    ...
                    try {
                        z.rid ? $(t, (0,
                        S.default)('.vquote[data-self-id="' + z.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1),
                        $(t, e.$el.find(".vcards")),
                        k.skip++),
                    ...
                    (0,
                    x.default)(e, t, "commitEvt")
                })
            };
            M.on("click", F),
            (0,
            S.default)(document).on("keydown", function(e) {
                e = event || e;
              ...
              , B = function t(n, r) {
                ...
                if (o > 0) {
                    ...
                    D(a, function(l) {
                        ...
                        (0,
                        c.default)(i[0]),
                        ++r < o ? t(n, r) : M.removeAttr("disabled")) : (i.val(i.val().replace(s, "")),
                        (0,
                        c.default)(i[0]),
        ...
        !function(o) {
            ...
            function p(e, t) {
                ...
                for (n = 0; n < e.length; n += 16)
                    ...
                    a = h,
                    s = v,
                    p = l(p, d, h, v, e[n], 7, -680876936),
                    v = l(v, p, d, h, e[n + 1], 12, -389564586),
                    h = l(h, v, p, d, e[n + 2], 17, 606105819),
                    d = l(d, h, v, p, e[n + 3], 22, -1044525330),
                    p = l(p, d, h, v, e[n + 4], 7, -176418897),
                    v = l(v, p, d, h, e[n + 5], 12, 1200080426),
                    h = l(h, v, p, d, e[n + 6], 17, -1473231341),
                    d = l(d, h, v, p, e[n + 7], 22, -45705983),
                    p = l(p, d, h, v, e[n + 8], 7, 1770035416),
                    v = l(v, p, d, h, e[n + 9], 12, -1958414417),
                    h = l(h, v, p, d, e[n + 10], 17, -42063),
                    d = l(d, h, v, p, e[n + 11], 22, -1990404162),
                    p = l(p, d, h, v, e[n + 12], 7, 1804603682),
                    v = l(v, p, d, h, e[n + 13], 12, -40341101),
                    h = l(h, v, p, d, e[n + 14], 17, -1502002290),
                    d = l(d, h, v, p, e[n + 15], 22, 1236535329),
                    p = c(p, d, h, v, e[n + 1], 5, -165796510),
                    v = c(v, p, d, h, e[n + 6], 9, -1069501632),
                    h = c(h, v, p, d, e[n + 11], 14, 643717713),
                    d = c(d, h, v, p, e[n], 20, -373897302),
                    p = c(p, d, h, v, e[n + 5], 5, -701558691),
                    v = c(v, p, d, h, e[n + 10], 9, 38016083),
                    h = c(h, v, p, d, e[n + 15], 14, -660478335),
                    d = c(d, h, v, p, e[n + 4], 20, -405537848),
                    p = c(p, d, h, v, e[n + 9], 5, 568446438),
                    v = c(v, p, d, h, e[n + 14], 9, -1019803690),
                    h = c(h, v, p, d, e[n + 3], 14, -187363961),
                    d = c(d, h, v, p, e[n + 8], 20, 1163531501),
                    p = c(p, d, h, v, e[n + 13], 5, -1444681467),
                    v = c(v, p, d, h, e[n + 2], 9, -51403784),
                    h = c(h, v, p, d, e[n + 7], 14, 1735328473),
                    d = c(d, h, v, p, e[n + 12], 20, -1926607734),
                    p = u(p, d, h, v, e[n + 5], 4, -378558),
                    v = u(v, p, d, h, e[n + 8], 11, -2022574463),
                    h = u(h, v, p, d, e[n + 11], 16, 1839030562),
                    d = u(d, h, v, p, e[n + 14], 23, -35309556),
                    p = u(p, d, h, v, e[n + 1], 4, -1530992060),
                    v = u(v, p, d, h, e[n + 4], 11, 1272893353),
                    h = u(h, v, p, d, e[n + 7], 16, -155497632),
                    d = u(d, h, v, p, e[n + 10], 23, -1094730640),
                    p = u(p, d, h, v, e[n + 13], 4, 681279174),
                    v = u(v, p, d, h, e[n], 11, -358537222),
                    h = u(h, v, p, d, e[n + 3], 16, -722521979),
                    d = u(d, h, v, p, e[n + 6], 23, 76029189),
                    p = u(p, d, h, v, e[n + 9], 4, -640364487),
                    v = u(v, p, d, h, e[n + 12], 11, -421815835),
                    h = u(h, v, p, d, e[n + 15], 16, 530742520),
                    d = u(d, h, v, p, e[n + 2], 23, -995338651),
    ...
    , function(e, t, n) {
        ...
        function r(e) {
            for (var t, n, o = Array.prototype.slice.call(arguments, 1); o.length; ) {
                t = o.shift();
                for (n in t)
                    t.hasOwnProperty(n) && ("[object Object]" === Object.prototype.toString.call(e[n]) ? e[n] = r(e[n], t[n]) : e[n] = t[n])
            }
            return e
        }
        e.exports = r
        ...
        t.default = function(e) {
            ...
            new Promise(function(t, n) {
                if ("jsonp" == e.method) {
                    ...
                    return e.body.callback = r,
                    e.body.t = Date.now(),
                    s.src = e.url + "?" + a(e.body),
                    window[r] = function(e) {
                        window[r] = null,
                        i.removeChild(s),
                        t(e)
                ...
                var l = "XMLHttpRequest"in window ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP")
                  , c = []
                  , u = []
                  , f = {}
                  , p = function e() {
                ...
                e.url = e.url + "?" + ("get" == e.method ? a(e.body) : ""),
                l.open(e.method || "get", e.url, !0),
                l.onload = function() {
                    l.getAllResponseHeaders().replace(/^(.*?):[^\S\n]*([\s\S]*?)$/gm, function(e, t, n) {
                        c.push(t = t.toLowerCase()),
                        u.push([t, n]),
                        f[t] = f[t] ? f[t] + "," + n : n
                    }),
                    t(p())
                ...
                ,
                l.onerror = n,
                l.withCredentials = "include" == e.credentials;
                for (var d in e.headers)
                    l.setRequestHeader(d, e.headers[d]);
    ...
    , function(e, t, n) {
        ...
        var r = n(0)
          , o = r("%Array%")
          , i = !o.isArray && n(1)("Object.prototype.toString");
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            return "default" === t && (a(e) || s(e)) && (t = "string"),
            l(e, "default" === t ? "number" : t)
        }
    }
    , function(e, t, n) {
        "use strict";
    ...
    , function(e, t, n) {
        ...
        function o(e, t) {
            ...
            function o(t, n) {
                var r = e.match(t);
                r && (e = e.substring(r[0].length),
                r[0].replace(t, n),
                m = !1)
            }
            function d() {
                var n = e.indexOf("--\x3e");
                n >= 0 && (t.comment && t.comment(e.substring(4, n)),
                e = e.substring(n + 3),
                m = !1)
            }
            function h() {
            ...
            function v(e, n, r, o) {
                ...
                r.replace(u, l),
                p || y.push(f),
                t.start && t.start(f, c, p)
            }
            function g(e, n) {
                var r, o = 0, i = a(n);
                if (i)
                    for (o = y.length - 1; o >= 0 && y[o] !== i; o--)
                        ;
                if (o >= 0) {
                    for (r = y.length - 1; r >= o; r--)
                        t.end && t.end(y[r]);
                    y.length = o
                }
            }
    ...
    , function(e, t, n) {
        !function(t, n) {
            ...
            function w(e, t, n) {
                ...
                try {
                    var s = ee.lex(e, t);
                    return t.walkTokens && w.walkTokens(s, t.walkTokens),
                    ce.parse(s, t)
                } catch (e) {
                    if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
                    t.silent)
                        return "<p>An error occurred:</p><pre>" + pe(e.message + "", !0) + "</pre>";
                    throw e
                }
            }
            var x = function(e) {
              ...
              , q = function() {
                ...
                t.nptable = function(e) {
                    ...
                    if (t) {
                        ...
                        if (n.header.length === n.align.length) {
                            ...
                            for (o = n.cells.length,
                            r = 0; r < o; r++)
                                n.cells[r] = U(n.cells[r], n.header.length);
                            return n
                        }
                    }
                }
                ...
                t.table = function(e) {
                    ...
                    if (t) {
                        ...
                        if (n.header.length === n.align.length) {
                            ...
                            for (o = n.cells.length,
                            r = 0; r < o; r++)
                                n.cells[r] = U(n.cells[r].replace(/^ *\| *| *\| *$/g, ""), n.header.length);
                            return n
                        }
                    }
                }
                ...
                t.url = function(e, t) {
                    ...
                    if (n = this.rules.inline.url.exec(e)) {
                        var r, o;
                        if ("@" === n[2])
                            r = B(this.options.mangle ? t(n[0]) : n[0]),
                            o = "mailto:" + r;
                        else {
                            var i;
                            do {
            ...
            H.bullet = /(?:[*+-]|\d{1,9}[.)])/,
            H.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/,
            H.item = W(H.item, "gm").replace(/bull/g, H.bullet).getRegex(),
            H.listItemStart = W(/^( *)(bull)/).replace("bull", H.bullet).getRegex(),
            ...
            H._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
            H.html = W(H.html, "i").replace("comment", H._comment).replace("tag", H._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
            ...
            K._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~",
            K.punctuation = W(K.punctuation).replace(/punctuation/g, K._punctuation).getRegex(),
            K._blockSkip = "\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>",
            K._overlapSkip = "__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*",
            ...
            K.blockSkip = W(K._blockSkip, "g").getRegex(),
            K.overlapSkip = W(K._overlapSkip, "g").getRegex(),
            K._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,
            ...
            K.reflink = W(K.reflink).replace("label", K._label).getRegex(),
            K.reflinkSearch = W(K.reflinkSearch, "g").replace("reflink", K.reflink).replace("nolink", K.nolink).getRegex(),
            K.normal = V({}, K),
            K.pedantic = V({}, K.normal, {
                strong: {
                    start: /^__|\*\*/,
            ...
            var G = {
              ...
              , ee = function() {
                function e(e) {
                    ...
                    this.options.pedantic ? (t.block = J.pedantic,
                    t.inline = X.pedantic) : this.options.gfm && (t.block = J.gfm,
                ...
                n.blockTokens = function(e, t, n) {
                    ...
                    for (var r, o, i, a; e; )
                        if (r = this.tokenizer.space(e))
                            ...
                            e = e.substring(r.raw.length),
                            r.type ? t.push(r) : (a = t[t.length - 1],
                            a.raw += "\n" + r.raw,
                            a.text += "\n" + r.text);
                    ...
                    if (this.tokens.links) {
                        ...
                        if (c.length > 0)
                            for (; null != (i = this.tokenizer.rules.inline.reflinkSearch.exec(l)); )
                                c.includes(i[0].slice(i[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, i.index) + "[" + Y("a", i[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
                    }
                    for (; null != (i = this.tokenizer.rules.inline.blockSkip.exec(l)); )
                        l = l.slice(0, i.index) + "[" + Y("a", i[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
                    for (; e; )
                        if (a || (s = ""),
                        a = !1,
                        o = this.tokenizer.escape(e))
                            ...
                            "link" === o.type && (o.tokens = this.inlineTokens(o.text, [], !0, r)),
                            t.push(o);
                        else if (o = this.tokenizer.strong(e, l, s))
                            e = e.substring(o.raw.length),
                            o.tokens = this.inlineTokens(o.text, [], n, r),
                            t.push(o);
                        else if (o = this.tokenizer.em(e, l, s))
                            e = e.substring(o.raw.length),
                            o.tokens = this.inlineTokens(o.text, [], n, r),
                            t.push(o);
                            ...
                            o.tokens = this.inlineTokens(o.text, [], n, r),
                            t.push(o);
                        else if (o = this.tokenizer.autolink(e, b))
                            e = e.substring(o.raw.length),
                            t.push(o);
                        else if (n || !(o = this.tokenizer.url(e, b))) {
                            if (o = this.tokenizer.inlineText(e, r, y))
                                e = e.substring(o.raw.length),
                                s = o.raw.slice(-1),
                                a = !0,
                                t.push(o);
              ...
              , ce = function() {
                function e(e) {
                    this.options = e || se,
                    this.options.renderer = this.options.renderer || new oe,
                ...
                return t.parse = function(e, t) {
                    ...
                    for (n = 0; n < x; n++)
                        ...
                        case "table":
                            ...
                            i = f.header.length,
                            r = 0; r < i; r++)
                                l += this.renderer.tablecell(this.parseInline(f.tokens.header[r]), {
                                    header: !0,
                                    align: f.align[r]
                                });
                            ...
                            i = f.cells.length,
                            r = 0; r < i; r++) {
                                for (s = f.tokens.cells[r],
                                l = "",
                                a = s.length,
                                o = 0; o < a; o++)
                                    l += this.renderer.tablecell(this.parseInline(s[o]), {
                                        header: !1,
                                        align: f.align[o]
                                    });
                        ...
                        case "list":
                            ...
                            r = 0; r < i; r++)
                                ...
                                y = g.task,
                                v = "",
                                g.task && (b = this.renderer.checkbox(m),
                                ...
                                v += this.parse(g.tokens, h),
                                u += this.renderer.listitem(v, y, m);
                        ...
                        case "paragraph":
                            ...
                            continue;
                        case "text":
                            for (u = f.tokens ? this.parseInline(f.tokens) : f.text; n + 1 < x && "text" === e[n + 1].type; )
                                f = e[++n],
              ...
              , ue = F.merge
              , fe = F.checkSanitizeDeprecation
              , pe = F.escape
              , de = x.getDefaults
              , he = x.changeDefaults
              , ve = x.defaults;
            return w.options = w.setOptions = function(e) {
                return ue(w.defaults, e),
                he(w.defaults),
                w
            }
            ,
            ...
            w.walkTokens = function(e, t) {
                for (var n, r = o(e); !(n = r()).done; ) {
                    ...
                    case "table":
                        ...
                        for (var c, u = o(i.tokens.cells); !(c = u()).done; )
                            for (var f, p = c.value, d = o(p); !(f = d()).done; ) {
                                var h = f.value;
                                w.walkTokens(h, t)
                            }
                        break;
            ...
            w.parseInline = function(e, t) {
                ...
                try {
                    ...
                    return t.walkTokens && w.walkTokens(n, t.walkTokens),
                    ce.parseInline(n, t)
                } catch (e) {
                    if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
                    t.silent)
    ...
    , function(e, t, n) {
        ...
        function s(e) {
            var t = e && e.prefix || "%{"
              , n = e && e.suffix || "}";
            if (t === y || n === y)
                throw new RangeError('"' + y + '" token is reserved for pluralization');
...
*/
    ...
    , function(e, t, n) {
        ...
        function z(e, t) {
            ...
            for (var c in e)
                h(e, c) && (n && String(Number(c)) === c && c < e.length || ee && a["$" + c]instanceof Symbol || (/[^\w$]/.test(c) ? r.push(t(c, e) + ": " + t(e[c], e)) : r.push(c + ": " + t(e[c], e))));
            if ("function" == typeof X)
                for (var u = 0; u < s.length; u++)
                    te.call(e, s[u]) && r.push("[" + t(s[u]) + "]: " + t(e[s[u]], e));
            return r
        }
        var C = "function" == typeof Map && Map.prototype
          , P = Object.getOwnPropertyDescriptor && C ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null
          , R = C && P && "function" == typeof P.get ? P.get : null
          , M = C && Map.prototype.forEach
          , F = "function" == typeof Set && Set.prototype
          , L = Object.getOwnPropertyDescriptor && F ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null
          , N = F && L && "function" == typeof L.get ? L.get : null
          , U = F && Set.prototype.forEach
          , B = "function" == typeof WeakMap && WeakMap.prototype
          , D = B ? WeakMap.prototype.has : null
          , q = "function" == typeof WeakSet && WeakSet.prototype
          , Q = q ? WeakSet.prototype.has : null
          , W = "function" == typeof WeakRef && WeakRef.prototype
          , V = W ? WeakRef.prototype.deref : null
          , H = Boolean.prototype.valueOf
          , K = Object.prototype.toString
          , G = Function.prototype.toString
          , Z = String.prototype.match
          ...
          , ne = ("function" == typeof Reflect ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(e) {
            return e.__proto__
        }
        : null)
          , re = n(113).custom
          , oe = re && p(re) ? re : null
          , ie = "function" == typeof Symbol && void 0 !== Symbol.toStringTag ? Symbol.toStringTag : null;
        e.exports = function e(t, n, A, C) {
            ...
            var F = n || {};
            if (h(F, "quoteStyle") && "single" !== F.quoteStyle && "double" !== F.quoteStyle)
                throw new TypeError('option "quoteStyle" must be "single" or "double"');
            if (h(F, "maxStringLength") && ("number" == typeof F.maxStringLength ? F.maxStringLength < 0 && F.maxStringLength !== 1 / 0 : null !== F.maxStringLength))
                throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
            var L = !h(F, "customInspect") || F.customInspect;
            if ("boolean" != typeof L && "symbol" !== L)
                throw new TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
            if (h(F, "indent") && null !== F.indent && "\t" !== F.indent && !(parseInt(F.indent, 10) === F.indent && F.indent > 0))
            ...
            if (S(t)) {
                for (var V = "<" + String(t.nodeName).toLowerCase(), K = t.attributes || [], G = 0; G < K.length; G++)
                    V += " " + K[G].name + "=" + r(o(K[G].value), "double", F);
                return V += ">",
            ...
            if (!a(t) && !s(t)) {
                var ae = z(t, P)
                  , se = ne ? ne(t) === Object.prototype : t instanceof Object || t.constructor === Object
                  , le = t instanceof Object ? "" : "null prototype"
                  , ce = !se && ie && Object(t) === t && ie in t ? v(t).slice(8, -1) : le ? "Object" : ""
                  , ue = se || "function" != typeof t.constructor ? "" : t.constructor.name ? t.constructor.name + " " : ""
                  , fe = ue + (ce || le ? "[" + [].concat(ce || [], le || []).join(": ") + "] " : "");
        ...
        if (!Object.keys) {
            ...
            r = function(e) {
                ...
                if (r && e.length > 0)
                    ...
                    for (var g in e)
                        p && "prototype" === g || !o.call(e, g) || f.push(String(g));
                if (l)
                    for (var m = h(e), y = 0; y < u.length; ++y)
                        m && "constructor" === u[y] || !o.call(e, u[y]) || f.push(u[y]);
                return f
            }
        }
        e.exports = r
